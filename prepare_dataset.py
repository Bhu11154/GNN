...
def process_graph():
    print("Entering process_graph method")
	...
	# print("Dataset: ", d)
        ...
        for n in tqdm(graph.nodes(), desc='Two hop neighbors'):
            ...
            # print("neighbour 2: ", neighbor_2) 
            neighbor_2 = set(neighbor_2)
            neighbor = neighbor_1 | neighbor_2
            # print("neighbour OR op: ", neighbor)
        ...
        for s in seeds:
          ...
          #  if 'ogbl' in d:
           #     data = train_test_split_edges_no_neg_adj_mask(data, test_ratio=0.05, two_hop_degree=two_hop_degree)
            ...
            print('Number of edges. 2-hop Local: ', local_edges.shape[1], 'Distant other than 2-hop subgraph of D-test:', distant_edges.shape[1])
...
#            cur_idx = 0
            ...
            #entity = sum(dataset[0]['num_nodes_dict'].values())
