...
class Trainer:
    ...
    def train_fullbatch(self, model, data, optimizer, args):
        ...
        data = data.to(device)
        print("d_train_mask sum (used as num_neg_samples): ", data.dtrain_mask.sum())
        print("data.dtrain_mask shape: ", data.dtrain_mask.shape)
    ...
    def eval(self, model, data, stage='val', pred_all=False):
        model.eval()
        print("Inside eval() for testing purpose!!")
